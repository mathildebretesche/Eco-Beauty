...
export default function MapFallbackScreen() {
  // Ce composant sert de "fallback" pour Expo Router (fichier sans suffixe .web/.native).
  // Il évite l'import de `react-native-maps` sur le web.
        ...
        <View className="flex-1" style={{ minHeight: 400 }}>
          ...
          >
            ...
            <Pressable
              onPress={() =>
                Linking.openURL(
                  'https://www.openstreetmap.org/#map=12/48.8566/2.3522'
                )
              }
